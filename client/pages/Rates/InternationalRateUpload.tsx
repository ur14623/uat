...
export default function InternationalRateUpload() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await fetch('/api/rates/international/upload', { method: 'POST', body: fd });
  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">International Rate Upload</h1>
          <p className="text-muted-foreground">Upload a new international tariff CSV/XLS</p>
        </div>
