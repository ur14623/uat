        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          <div>
            ...
            <p className="text-muted-foreground">
              Filter, view, and manage notifications
            </p>
          </div>
          <Link to="/master_notification_add">
            <Button className="bg-brand hover:bg-brand-600" type="button">
              <PlusCircle className="h-4 w-4 mr-2" /> Create Notification
            </Button>
          </Link>
        </div>
        ...
        <Card>
          ...
          <CardContent className="flex items-end gap-4 overflow-x-auto whitespace-nowrap">
            ...
            <div className="inline-flex flex-col min-w-[180px] shrink-0">
              ...
              <Select
                value={filters.validity || "__all__"}
                onValueChange={(v) =>
                  setFilters((f) => ({
                    ...f,
                    validity: v === "__all__" ? "" : v,
                  }))
                }
              >
                <SelectTrigger className="mt-2">
            ...
            <div className="inline-flex flex-col min-w-[200px] shrink-0">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFilters((f) => ({ ...f, bundleType: e.target.value }))
                }
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <MessageCircle className="h-5 w-5" /> Notifications
            </CardTitle>
          </CardHeader>
          <CardContent>
                    ...
                    <TableRow key={it.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            href={`/api/notifications/${it.id}/download`}
                            className="inline-flex"
                          >
                            <Button variant="ghost" size="icon">
