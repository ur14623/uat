            ...
            <div className="space-y-4">
              <Card>
                ...
                <CardContent className="text-sm space-y-2">
                  ...
                  <div>
                    <span className="text-muted-foreground">NCC ID:</span>{" "}
                    <span className="font-mono">{item.nccId}</span>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {(["en", "am", "om", "so", "ti"] as const).map((lang) => (
                      <div key={lang}>
                        ...
                        <textarea
                          className="mt-2 w-full min-h-28 rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                          value={item?.marketing[lang] || ""}
                          onChange={(e) =>
                            setItem((it) =>
                              it
                                ? {
